...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item">Edit Sales</div>
        </div>
        </div>
            ...
            <div class="card">
               ...
               <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" name="id_sales" class="form-control" value="<?= $sales->id_sales;?>" readonly>
                    <small class="alert-danger"><?php echo form_error('id_sales'); ?></small>
                </div>
                <div class="form-group">
                    <label>Nama Sales</label>
                    <input type="text" name="nama_sales" class="form-control" value="<?= $sales->nama_sales;?>">
                    <small class="alert-danger"><?php echo form_error('nama_sales'); ?></small>
                </div>
                <div class="form-group">
                    <label>Email Sales</label>
                    <input type="email" name="email_sales" class="form-control" value="<?= $sales->email_sales;?>">
                    <small class="alert-danger"><?php echo form_error('email_sales'); ?></small>
                </div>
                <div class="form-group">
                    <label>Alamat Sales</label> 
                    <input type="text" name="alamat_sales" id="alamat_sales" class="form-control" value="<?= $sales->alamat_sales;?>"></input>
                ...
                <div class="form-group">
                 <label>Nomor Telephone</label>
                  ...
                  <div class="input-group-prepend">
                    ...
                    <input type="text" name="tlp_sales" value="<?= $sales->tlp_sales;?>" class="form-control phone-number">
                    </div>
                ...
                <div class="form-group">
                    <label>Urutan</label> 
                    <input type="number" name="urutan" class="form-control" value="<?= $sales->urutan;?>">
                </div>
