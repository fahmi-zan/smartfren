            ...
            <div class="card-body">
              <div class="form-group row mb-4">
                ...
                <div class="col-sm-12 col-md-7">
                  <input type="text" name="kode_barang" class="form-control" value="<?= $barang->kode_barang;?>" require>
              ...
              <div class="form-group row mb-4">
                ...
                <div class="col-sm-12 col-md-7">
                  <input type="text" name="nama_barang" class="form-control" value="<?= $barang->nama_barang;?>" require>
              ...
              <div class="form-group row mb-4">
                ...
                <div class="col-sm-12 col-md-7">
                  ...
                  <option value="<?= $kategori->id_kategori ;?>" <?php if ($barang->id_kategori == $kategori->id_kategori) { echo "selected"; } ?>><?= $kategori->nama_kategori;?></option>
                  <?php }?>
                  </select>
                </div>
              </div>
              ...
              <div class="form-group row mb-4">
                ...
                <div class="col-sm-12 col-md-7">
                  <textarea name="keterangan" class="form-control summernote-simple" value=""><?= $barang->keterangan;?></textarea>
                </div>
              </div>
              ...
              <div class="form-group row mb-4">
                ...
                <div class="col-sm-12 col-md-7">
                  <textarea type="text" name="keyword" class="form-control summernote-simple" value=""><?= $barang->keyword;?></textarea>
                </div>
              </div>
              ...
              <div class="form-group row mb-4">
                ...
                <div class="col-sm-12 col-md-7">
                  <select name="status_barang" class="form-control selectric">
                    ...
                    <option value="Draft" <?php if($barang->status_barang == "Draft") { echo "selected"; } ?>>DRAFT</option>
                  </select>
                </div>
              </div>
